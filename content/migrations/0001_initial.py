    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video', models.FileField(upload_to='contents', validators=[tools.validators.validate_size, tools.validators.validate_extension])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(default=tools.random_generate.random_code, max_length=16, unique=True)),
                ('title', models.CharField(max_length=64)),
                ('short_video', models.FileField(upload_to='statuses', validators=[tools.validators.validate_size, tools.validators.validate_extension])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=64)),
                ('contents', models.ManyToManyField(blank=True, to='content.VideoContent')),
